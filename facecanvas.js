...
function FaceCanvas(canvas, debugcanvas) {
    ...
    canvas.repaint = function() {
        ...
        if (canvas.active && canvas.animating) {
            ...
            let epsilon = [expressions.sv[0]*Math.cos(canvas.theta),expressions.sv[1]*Math.sin(canvas.theta),0,0,0,0,0,0,0,0];
            ...
            canvas.theta += 0.1;
            console.log(canvas.theta);
            //debugcanvas.setPoints(points2D);
            //debugcanvas.repaint();
